              ...
              <ul class="nav__list">
                  ...
                  <li class="nav__item">
                   ...
                   <!---After login is here
                      ...
                      <li class="nav__item after_login" hidden>
                      <div class="profile">
                          <div class="user">
                          ...
                          <div class="img-box">
                              <img src="@/assets/img/man4.png" alt="some user image">
                          </div>
                      </div>
                      <div class="menu">
                          <ul>
                  ...
                  <li class="nav__item before_login" >
                      <div class="profile">
                          ...
                          <div class="img-box">
                              <img src="@/assets/avatar-3d/anonymous.png" alt="some user image">
                          </div>
                      </div>
                      <div class="menu">
                          <ul>
                              <li><a href="auth-page/index.html"><i class="ph-bold ph-user"></i>&nbsp;Login</a></li>
                              <li><a href="auth-page/register.html"><i class="ph-bold ph-envelope-simple"></i>&nbsp;Register</a></li>
                          </ul>
                      </div>
                  </li>
